...
do
    ...
    do
        timeout 3600s python run_hyperparam_search.py --ds $d --method $m --subsample 2
    done
    ...
    do
        timeout 3600s python run_hyperparam_search.py --ds $d --method $m --subsample 3
    done
    ...
    do
        timeout 3600s python run_hyperparam_search.py --ds $d --method $m --subsample 5
    done
done